 ...
 * The class-level @runTestsInSeparateProcesses annotation is covered here; it isolates every test
 ...
 * extension is missing. The counts therefore match plain PHPUnit.
 *
 * @internal
 * @coversNothing
 *
