 ...
 * never stopped: every test ran, and the failure surfaced in the deferred block. While any
 ...
 * with mode-identical assertions (the alphabetical/declaration order guarantees the failing
 * test runs first).
 *
 * @internal
 * @coversNothing
