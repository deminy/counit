 ...
 * compatibility workflow with --coverage-filter pointed at the support/ directory, asserting the
 * exact same aggregate percentages with and without Swoole (neverCalled() keeps the expected
