 ...
 * called only after it, one never called. The compatibility workflow points --coverage-filter at
 * this directory and asserts the aggregate percentages are identical with and without Swoole --
