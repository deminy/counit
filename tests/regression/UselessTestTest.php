 ...
 * a RiskyTestError handed to the public TestResult::addFailure() -- risky listing, summary count
 * and the --fail-on-risky exit code all included (see UselessTests). Run by the compatibility
 * workflow in three flag states, asserting the exact blocking-mode summaries and exit codes with
 * and without Swoole.
 *
 * @internal
 * @coversNothing
