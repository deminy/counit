...
class Helper
{
     ...
     * the run's reported total (see CounitExtension for how the total is kept exact). With the
     * exclusion, tests doing real file IO simply block for its (local, fast) duration instead of
     * yielding; network IO and sleep() -- what this package exists to parallelize -- stay hooked.
     *
